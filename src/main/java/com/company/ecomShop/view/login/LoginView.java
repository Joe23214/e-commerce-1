package com.company.ecomShop.view.login;
...
import com.company.ecomShop.view.passworddimenticata.Passworddimenticata;
...
// =======================
    ...
    public void onLoginForgotPassword(final AbstractLogin.ForgotPasswordEvent event) {
        viewNavigators.view(this, Passworddimenticata.class).navigate();
    }
