package com.company.ecomShop.view.productlist;
...
//import com.vaadin.lineawesome.LineAwesomeIcon;
...
@Route(value = "ProductListView", layout = MainView.class)
@ViewController(id = "Productlistview")
@ViewDescriptor(path = "ProductListView.xml")
public class Productlistview extends StandardView {
    ...
    public void onInit(final InitEvent event) {
        addClassNames( FLEX, Height.FULL, BLOCK);
        idDiv.add(createSidebar(), createContent());
        closeSidebar();
    }

    public void ProductListView() {
        addClassNames( FLEX, Height.FULL, HIDDEN);
    ...
    public Component createToolbar() {
        ...
        brands.addClassNames(HIDDEN, "lg:inline-flex", MinWidth.NONE);
